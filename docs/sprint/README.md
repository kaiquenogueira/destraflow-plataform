...
|---|--------|-----------|--------------|---------|-----------|--------------|
| [01](./sprint-01-quota-ia-e-sinal-de-uso.md) | Quota de IA e sinal de uso | 🔴 Crítica | Média | 2–3 dias | — | ✅ Sim — worker nunca reseta quota (throttle permanente) |
| [02](./sprint-02-identidade-de-telefone.md) | Identidade de telefone | 🔴 Crítica | Média | 3–5 dias | — | ✅ Sim — histórico de chat some na UI |
| [03](./sprint-03-seguranca-credenciais-decrypt.md) | Segurança de credenciais (decrypt) | 🟠 Alta | Baixa–Média | 2–3 dias | — | ⚠️ Vetor de segurança — credencial em texto plano abre pool |
